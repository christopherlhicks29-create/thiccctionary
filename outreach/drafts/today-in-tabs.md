...
**Recipient:** Rusty Foster (verify current email at pitch time)
**Subject line options (pick one at send time):**
- A satirical online dictionary that catalogs only objects, never people
- "Thiccc" as an adjective for refrigerators (a project)
- Built a dictionary that takes one specific cultural habit and points it at cement mixers
...
Two recent entries to give you a sense:
- Concrete Mixer: thiccctionary.com/entries/2026-04-27.html
- Ram 3500 Dually: thiccctionary.com/entries/2026-04-29.html
...
- Replace [TODO] with a real reference to one of Rusty's recent newsletters BEFORE sending. This is the most important customization.
- Keep the email under 250 words. The draft above is 178.
- Send mid-morning ET on a Tuesday or Wednesday for max reply odds.
